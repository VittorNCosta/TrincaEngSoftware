...
export const LEGACY_CAMPAIGN_MAP_ASSETS = {
  ...
  'legacy-world-4': require('../../assets/map/map_world1_bg.png') as ImageSourcePropType,
  'legacy-world-5': require('../../assets/map/map_world2_bg.png') as ImageSourcePropType,
...
export const CHAPTER_MAP_ASSETS = {
  'chapter-map-1': require('../../assets/map/map_world1_bg.png') as ImageSourcePropType,
  'chapter-map-2': require('../../assets/map/map_world2_bg.png') as ImageSourcePropType,
  'chapter-map-3': require('../../assets/map/map_world3_select_bg.png') as ImageSourcePropType,
  'chapter-map-4': require('../../assets/map/map_world3_bg.png') as ImageSourcePropType,
  'chapter-map-5': require('../../assets/map/map_world3_home_bg.png') as ImageSourcePropType,
  'chapter-map-6': require('../../assets/map/map_world1_bg.png') as ImageSourcePropType,
  'chapter-map-7': require('../../assets/map/map_world2_bg.png') as ImageSourcePropType,
  'chapter-map-8': require('../../assets/map/map_world3_bg_wide.png') as ImageSourcePropType,
  'chapter-map-9': require('../../assets/map/map_world3_shop_bg.png') as ImageSourcePropType,
  'chapter-map-10': require('../../assets/map/map_bonus_bg.png') as ImageSourcePropType,
} as const;

export type CampaignMapSegmentAssetKey = keyof typeof CAMPAIGN_MAP_SEGMENT_ASSETS;
export type ChapterMapAssetKey = keyof typeof CHAPTER_MAP_ASSETS;
export type LegacyCampaignMapRendererKey = keyof typeof LEGACY_CAMPAIGN_MAP_ASSETS;
...
export const resolveChapterMapAsset = (
  ...
  hasOwnKey(CHAPTER_MAP_ASSETS, rendererKey) ? CHAPTER_MAP_ASSETS[rendererKey] : undefined;
