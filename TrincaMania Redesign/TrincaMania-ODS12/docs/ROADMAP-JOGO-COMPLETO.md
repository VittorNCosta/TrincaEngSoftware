...
| C-30 | Decidir e implementar destino dos Capítulos                              | [VOCÊ] + [CC] | P1   | Opções: (a) esconder do menu, (b) manter como "modo infinito" pós-jogo, (c) remover o código. Hoje `ChaptersScreen` é acessível por `onOpenChapters`.                                                                                                                                                                                                                                                                                                                                                                                                                                                        | GPT-5.6 Terra |
...
| ----- | --------------------------------------- | ------------- | --------- | ---- | ------------- |
| A-24a | `assets/map/worlds/w21_jardim_map.png`  | Fundo de mapa | [CC→VOCÊ] | P1   | GPT-5.6 Terra |
| A-24b | `assets/map/worlds/w21_jardim_game.png` | Fundo de jogo | [CC→VOCÊ] | P1   | GPT-5.6 Terra |
...
| ID   | Tarefa                                                    | Quem      | Prio | Detalhe                                                                                                                                                     | Codex         |
| ---- | --------------------------------------------------------- | --------- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| A-25 | Ícone do app 1024×1024                                    | [CC→VOCÊ] | P0   | Hoje 1254×1254, fora do padrão. Símbolo de reciclagem + trinca, sem texto.                                                                                  | GPT-5.6 Terra |
| A-26 | Adaptive icon Android 1024×1024                           | [CC→VOCÊ] | P0   | Elemento dentro do círculo de 66%. `backgroundColor` hoje é `#4B148C` (roxo — reavaliar, não é cor CONAMA).                                                 | GPT-5.6 Terra |
| A-27 | Splash screen                                             | [CC→VOCÊ] | P1   | `SplashIntroScreen.tsx` tem 537 linhas — conferir o que já é desenhado em código.                                                                           | GPT-5.6 Terra |
| A-28 | Selo de marco "Descanso" 320×320                          | [CC→VOCÊ] | P1   | Substitui `forest_rest_cart.png` (carrinho de floresta, tema antigo). Proposta: carrinho de catador.                                                        | GPT-5.6 Terra |
| A-29 | Selo de marco "Loja" 320×320                              | [CC→VOCÊ] | P1   | Hoje `map_shop.png`                                                                                                                                         | GPT-5.6 Terra |
| A-30 | Selo de marco "Guardião" 320×320                          | [CC→VOCÊ] | P1   | Não existe hoje                                                                                                                                             | GPT-5.6 Terra |
| A-31 | Marcador de portal entre mundos 320×320                   | [CC→VOCÊ] | P1   | Hoje `forest-portal-rune` (runa — fantasia). Proposta: seta de ciclo.                                                                                       | GPT-5.6 Terra |
| A-32 | Nós de fase (bloqueado/atual/completo)                    | [CC→VOCÊ] | P2   | `map_level_locked/current/complete.png`. Avaliar se vira SVG em código.                                                                                     | GPT-5.6 Terra |
...
| A-36 | Integrar cada asset entregue no código                    | [VOCÊ→CC] | P0   | `campaignMapAssets.ts` + `getGameBackground` em `GameScreen.tsx`                                                                                            | GPT-5.6 Terra |
...
| ---- | ------------------------- | --------------- | ------------------------------------------------------------------- | --------- | ------------- |
| S-01 | `ambient_parque.mp3`      | 1 · Parque      | Pássaros distantes, folhas, passos ocasionais                       | [CC→VOCÊ] | GPT-5.6 Terra |
| S-02 | `ambient_vale.mp3`        | 2 · Vale        | Esteira ao longe, vento de vale, maquinário abafado                 | [CC→VOCÊ] | GPT-5.6 Terra |
| S-03 | `ambient_central.mp3`     | 3 · Central     | Galpão amplo, eco, prensa distante, ventilação                      | [CC→VOCÊ] | GPT-5.6 Terra |
| S-04 | `ambient_viveiro.mp3`     | 4 · Viveiro     | Regador, insetos, lona ao vento                                     | [CC→VOCÊ] | GPT-5.6 Terra |
| S-05 | `ambient_usina.mp3`       | 5 · Usina       | Zumbido grave de biodigestor, vapor, pá revolvendo                  | [CC→VOCÊ] | GPT-5.6 Terra |
| S-06 | `ambient_cooperativa.mp3` | 6 · Cooperativa | Carrinho de metal, fardos, vozes distantes indistintas              | [CC→VOCÊ] | GPT-5.6 Terra |
| S-07 | `ambient_rota.mp3`        | 7 · Rota        | Rodovia distante, caminhão manobrando, engradado                    | [CC→VOCÊ] | GPT-5.6 Terra |
| S-08 | `ambient_forum.mp3`       | 8 · Fórum       | Praça aberta, murmúrio cívico, bandeira ao vento                    | [CC→VOCÊ] | GPT-5.6 Terra |
| S-09 | `ambient_distrito.mp3`    | 9 · Distrito    | Prensa hidráulica ao longe, esteira rolante, zumbido grave de forno | [CC→VOCÊ] | GPT-5.6 Terra |
| S-10 | `ambient_cupula.mp3`      | 10 · Cúpula     | Murmúrio de plenário, papel manuseado, passos em saguão amplo       | [CC→VOCÊ] | GPT-5.6 Terra |
...
| CI-21     | `--auto-submit` no build de produção                         | [CC]   | P2   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | GPT-5.6 Sol   |
| CI-22     | Configurar EAS Update (OTA) para correção de JS              | [CC]   | P1   | Correção de bug sem passar pela revisão da loja                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | GPT-5.6 Sol   |
...
| CI-24     | Canal de update por branch (`preview`/`production`)          | [CC]   | P2   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | GPT-5.6 Terra |
...
| CI-34     | Automatizar validação de PR e corrigir checks de entrega     | [CC]   | P1   | Corrigir as falhas do PR #225 sem afrouxar gates; adicionar validação local, monitor remoto por SHA e instruções de correção até os checks passarem. Testar o monitor e compra/expiração/persistência dos espaços extras. Entrega no [PR #225](https://github.com/VittorNCosta/TrincaEngSoftware/pull/225), aberta enquanto aguarda validação e integração.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | GPT-5.6 Terra |
...
| SEC-15     | Rodar `/security-review` antes do release                      | [CC]   | P0   | Skill já disponível                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | GPT-5.6 Sol |
...
| Q-02     | Fluxo E2E: abrir app → mapa → jogar fase 1 → vencer            | [CC]   | P1   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | GPT-5.6 Terra |
| Q-03     | Fluxo E2E: comprar na loja                                     | [CC]   | P2   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | GPT-5.6 Terra |
| Q-04     | Fluxo E2E: perder vida e esperar recarga                       | [CC]   | P2   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | GPT-5.6 Terra |
...
| Q-07     | Quebrar `GameScreen.tsx` (3166 linhas)                         | [CC]   | P1   | O `CLAUDE.md` já avisa para não deixar crescer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | GPT-5.6 Sol   |
| Q-08     | Quebrar `LevelSelectScreen.tsx` (1879 linhas)                  | [CC]   | P2   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | GPT-5.6 Sol   |
| Q-09     | Quebrar `App.tsx` (1169 linhas)                                | [CC]   | P2   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | GPT-5.6 Sol   |
...
| Q-12     | ✅ ADR sobre a mudança 203 → 100 fases                         | [CC]   | P1   | **Feito 08/09.** `docs/adr/0004-campanha-vira-10-mundos-de-10-fases.md`: por que 10×10, opções consideradas e consequências (destino dos Capítulos segue em aberto no C-30).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | GPT-5.6 Terra |
| Q-13     | Resolver o gap do Modo Dev                                     | [CC]   | P2   | `CLAUDE.md` registra: escreve direto no save real, não é reversível                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | GPT-5.6 Sol   |
...
| R-04 | Ficha da loja: título + descrição curta + longa     | [CC→VOCÊ] | P0   | Com o enquadramento ODS 12                                            | GPT-5.6 Terra |
| R-05 | 8 screenshots de telefone                           | [VOCÊ]    | P0   | Mínimo 2, ideal 8. Rodar o app e capturar.                            | Manual        |
| R-06 | Feature graphic 1024×500                            | [CC→VOCÊ] | P0   |                                                                       | GPT-5.6 Terra |
| R-07 | Ícone da loja 512×512                               | [CC→VOCÊ] | P0   |                                                                       | GPT-5.6 Terra |
| R-08 | Vídeo de preview (opcional)                         | [VOCÊ]    | P2   |                                                                       | Manual        |
| R-09 | Política de privacidade hospedada                   | [CC→VOCÊ] | P0   | Obrigatória. Como o jogo é offline, é curta.                          | GPT-5.6 Sol   |
| R-10 | Questionário de classificação etária                | [VOCÊ]    | P0   |                                                                       | Manual        |
| R-11 | Data safety form                                    | [VOCÊ]    | P0   | Declarar que não coleta dados                                         | Manual        |
...
| R-16 | Rodar `/security-review`                            | [CC]      | P0   |                                                                       | GPT-5.6 Sol   |
| R-17 | Tag `v1.0.0` e release                              | [CC]      | P0   |                                                                       | GPT-5.6 Sol   |
